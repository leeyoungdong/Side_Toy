...
# 이미지 경로 생성
dataframe["image_path"] = f"/content/drive/MyDrive/png_jjw"                    + "/" + dataframe.patient_id.astype(str)                    + "/" + dataframe.series_id.astype(str)                    + "/" + "img_256x256_d1_original"                    + "/" + "image_" + dataframe.groupby("series_id").cumcount().add(1).astype(str).str.zfill(3) + ".png"
